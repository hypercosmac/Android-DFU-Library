...
fun OnboardingScreen(
    ...
    // Auto-advance when device connects (optional - user can also tap continue)
    LaunchedEffect(uiState.isConnected) {
        if (uiState.isConnected && uiState.currentStep is OnboardingStep.Pairing) {
            // Don't auto-advance, let user tap continue button
        }
    }
}
